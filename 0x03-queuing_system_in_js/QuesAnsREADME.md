0x03-queuing_system_in_js PROJECT INSTRUCTIONS
Resources
Read or watch:
...
package.json
Click to show/hide file contents (content below)
.babelrc
Click to show/hide file contents(content below)
and…
...
mandatory
Score: 0.0% (Checks completed: 0.0%)
Install node_redis using npm   : https://github.com/redis/node-redis
